...
public class ChatRecordView extends JFrame implements ActionListener{
	
	
	public static void main(String[] args)
	{
		ChatRecordView abc = new ChatRecordView(new Message());
	}
	...
	public ChatRecordView(Message msg) 
	{
		this.msg = msg;
		setSize(494,500);
		try 
	...
	private void init(){
		...
		JLabel lblInfo = new JLabel("聊天记录");
		...
		paneBtn.add(new FillWidth(5,20,bgColor));
		txtMessage.setText(this.msg.getContext().toString());
